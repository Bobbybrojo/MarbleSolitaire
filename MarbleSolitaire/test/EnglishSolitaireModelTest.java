...
public class EnglishSolitaireModelTest {
  ...
  public void init() {
    ...
    this.model7Arm = new EnglishSolitaireModel(7);
  }
  ...
  public void testIsGameOver() {
    ...
    // Tests that a game of marble solitaire can be played on a standard board with a score of 1
    this.modelStandard.move(3, 5, 3, 3);
    ...
    // Tests that a game over can occur when there are more than 1 marbles
    init();

    this.modelStandard.move(5, 3, 3, 3);
    assertFalse(this.modelStandard.isGameOver());
    this.modelStandard.move(2, 3, 4, 3);
    assertFalse(this.modelStandard.isGameOver());
    this.modelStandard.move(0, 3, 2, 3);
    assertFalse(this.modelStandard.isGameOver());
    this.modelStandard.move(3, 5, 3, 3);
    assertFalse(this.modelStandard.isGameOver());
    this.modelStandard.move(3, 2, 3, 4);
    assertFalse(this.modelStandard.isGameOver());
    this.modelStandard.move(3, 0, 3, 2);
    assertTrue(this.modelStandard.isGameOver());
  }
  ...
  public void testGetSlotAt() {
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid, modelStandard.getSlotAt(1, 1));
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid, modelStandard.getSlotAt(1, 5));
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid, modelStandard.getSlotAt(5, 1));
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid, modelStandard.getSlotAt(5, 5));
  ...
  public void testGetScore() {
    ...
    assertEquals(104, this.model5Arm.getScore());
    assertEquals(216, this.model7Arm.getScore());
    ...
    this.modelStandard.move(2, 1, 4, 1);
    assertEquals(4, this.modelStandard.getScore());
    this.modelStandard.move(4, 1, 4, 3);
    assertEquals(3, this.modelStandard.getScore());
    this.modelStandard.move(4, 3, 2, 3);
    assertEquals(2, this.modelStandard.getScore());
    this.modelStandard.move(1, 3, 3, 3);
    assertEquals(1, this.modelStandard.getScore());
  }
}